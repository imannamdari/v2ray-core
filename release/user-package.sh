...
build_v2() {
	...
	LDFLAGS="-s -w -buildid= -X github.com/imannamdari/v2ray-core/v5.codename=${CODENAME} -X github.com/imannamdari/v2ray-core/v5.build=${BUILDNAME} -X github.com/imannamdari/v2ray-core/v5.version=${VERSIONTAG}"
